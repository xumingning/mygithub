    ...
    <span class="carousel-control-next-icon"></span>
        ...
        <div class="row ftco-animate">
		 <p style="width:100%;font-size:20px;padding-left:5%;padding-bottom:13px;border-bottom:2px solid #ccc;">
        	...
        	<table width="100%">
        	<script>var routeway ='<s:property value="#introduce.routeway"/>'.split(',');
        	for(var i=0;i<routeway.length;i++){
        	document.write('<tr><td><span style="margin:25px auto;border-radius:50%;background:#ccc;width:50px;height:50px;line-height:50px;text-align:center;float:left">D'+(i+1)+'</span></td>');
        	document.write('<td>'+routeway[i]+'<td/>');
        	}
        	</script>
        	</table>
        ...
        <p style="margin:auto;padding:30px 15%;color:#000;font-size:16px;">		
			<script>
			var way = '<s:property value="#introduce.travel"/>'.split('/');
			for(var i=0;i<way.length;i++){
			document.write(way[i]+'<br>');
			}
